(function () {
  ...
  async function saveDataPrivate(token, data) {
    ...
    // Vor JEDEM Speichern den aktuellen SHA holen, damit 409-Konflikte vermieden werden.
  ...
  async function init() {
    ...
    if (document.body.dataset.page === "admin") {
      // Kein automatisches Neuladen im Admin, damit kein SHA-Konflikt durch Hintergrund-Refresh entsteht.
    }
  }
